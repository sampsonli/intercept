...
let co = require('co');
let phone = '13088861255'

function send() {
    co(function *() {
        let result;
        while (true){
            result = yield postmsg();
            console.log(result);
            yield wait(1900)
        }
    }).catch(function (e) {
